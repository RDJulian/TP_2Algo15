        ...
        if "parts" in payload_mensaje:
            ...
            if evaluacion:
                ...
                if (
                    ...
                    if (
                        "alumnos.csv" in os.listdir(path)
                        and "docentes.csv" in os.listdir(path)
                        and "docente-alumnos.csv" in os.listdir(path)
                    ):
...
def validar_entrega(padron: str, remitente: str, path: str, payload_mensaje) -> bool:
